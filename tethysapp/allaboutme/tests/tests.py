    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.allaboutme"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.allaboutme.tests.tests"

        To run tests in the AllaboutmeTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.allaboutme.tests.tests.AllaboutmeTestCase"

        To run only the test_if_tethys_platform_is_great function in the AllaboutmeTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.allaboutme.tests.tests.AllaboutmeTestCase.test_if_tethys_platform_is_great"
...
class AllaboutmeTestCase(TethysTestCase):
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/allaboutme/')  # The final '/' is essential for all pages/controllers
